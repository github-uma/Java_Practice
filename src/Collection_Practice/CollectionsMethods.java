...
public class CollectionsMethods {
	...
	// Sorting all the elements of the specified collection according to descending  sorting order
	Collections.sort(arrlist,Collections.reverseOrder()); // this is applicable for derived datatypes only
